			...
			{props.collapsed ? (
				<>
					<Typography variant="body2" sx={{ mb: 0.75 }}>
						{currentTarget?.title ?? t("未选择目标", "No target selected")} · {props.companionRuntimeState.observationReady ? t("观察已就绪", "Observation ready") : t("观察未就绪", "Observation not ready")}
					</Typography>
					<Stack direction="row" spacing={0.5} justifyContent="space-between" alignItems="center">
						...
						<Button size="small" variant="text" onClick={props.onToggleCollapsed}>
							{t("展开", "Expand")}
						</Button>
					</Stack>
