...
| F2 | 运行时控制器最小实现 | 运行模式管理（auto/stopped）、模式变更通知 |
...
| F8 | 状态管理选型 | 确定 React 状态管理方案（Zustand / Jotai / 自建） |
...
| 急停/人工接管完整流程 | Phase 3 任务，本阶段 runtime 只管模式切换 |
| 打包分发 | Phase 5 任务 |
